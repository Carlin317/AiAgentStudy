...
[StrOutputParserDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/StrOutputParserDemo.py ":include :type=code")
...
[JsonOutputParserDemo.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/JsonOutputParserDemo.py ":include :type=code")
...
[JsonOutputParser_GetFormatInstructions.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/JsonOutputParser_GetFormatInstructions.py ":include :type=code")
...
[StructuredOutput_TypedDict.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/StructuredOutput_TypedDict.py ":include :type=code")
...
[AnnotatedTypedDict.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/AnnotatedTypedDict.py ":include :type=code")
...
[AnnotatedPydantic.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/AnnotatedPydantic.py ":include :type=code")
...
[StructuredOutput_Pydantic.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/05_parser/StructuredOutput_Pydantic.py ":include :type=code")
