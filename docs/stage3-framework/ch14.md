...
**建议下一步：** 学习 [第 15 章 LCEL 与链式调用](/stage3-framework/ch15)，把本章的解析器与 [第 13 章](/stage3-framework/ch13) 的 Prompt、[第 11 章](/stage3-framework/ch11) 的 Model 串成真正的 `prompt | model | parser` 链。
