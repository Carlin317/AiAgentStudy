...
[BuildWholeGraphSummary.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/02-graph/BuildWholeGraphSummary.py ":include :type=code")
...
[DefState.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/DefState.py ":include :type=code")
...
[StateSchema.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/schema/StateSchema.py ":include :type=code")
...
[StateReducer_Default.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_Default.py ":include :type=code")
...
[StateReducer_AddMessages.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_AddMessages.py ":include :type=code")
...
[StateReducer_OperatorAdd.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorAdd.py ":include :type=code")

**字符串连接案例：**

【案例源码】`案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorAdd2.py`

[StateReducer_OperatorAdd2.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorAdd2.py ":include :type=code")

**数值累加案例：**

【案例源码】`案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorAdd3.py`

[StateReducer_OperatorAdd3.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorAdd3.py ":include :type=code")
...
[StateReducer_OperatorMul.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_OperatorMul.py ":include :type=code")
...
[StateReducer_Custom.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducer_Custom.py ":include :type=code")
...
[StateReducersMyChatBot.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-3-LangGraph框架/03-state/reducers/StateReducersMyChatBot.py ":include :type=code")
...
**建议下一步：** 先按顺序跑一遍 `BuildWholeGraphSummary.py`、`DefState.py`、`StateSchema.py` 和 `03-state/reducers` 目录下所有 Reducer 案例，然后自己做两个小练习：把 `BuildWholeGraphSummary.py` 的 `process_data` 改成用 `operator.add` 追加历史记录；把 `StateReducersMyChatBot.py` 再加一个 `latest_summary` 字段，用默认覆盖保存最新摘要。做完后进入 [第 24 章 - LangGraph API：节点、边与进阶](/stage3-framework/ch24)，继续学习节点、普通边、条件边和 `Command` / `Send` / `Runtime`。
