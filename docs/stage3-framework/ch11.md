...
[ModelIO_Params.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_Params.py ":include :type=code")
...
[ModelIO_OpenAI.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_OpenAI.py ":include :type=code")
...
[ModelIO_ChatOpenAI.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_ChatOpenAI.py ":include :type=code")
...
[ModelIO_Init_chat_model.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_Init_chat_model.py ":include :type=code")
...
[ModelIO_DeepSeek.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_DeepSeek.py ":include :type=code")
...
[ModelIO_Qwen.py](https://github.com/didilili/ai-agents-from-zero/blob/main/案例与源码-2-LangChain框架/02-models_io/ModelIO_Qwen.py ":include :type=code")
...
**建议下一步：** 先把本章的 `02-models_io` 目录按顺序跑一遍，推荐顺序是：`ModelIO_OpenAI.py` → `ModelIO_ChatOpenAI.py` → `ModelIO_Init_chat_model.py` → `ModelIO_Params.py` → `ModelIO_DeepSeek.py` → `ModelIO_Qwen.py`。跑完之后，再进入 [第 12 章 Ollama 本地部署与调用](/stage3-framework/ch12)、[第 13 章 提示词与消息模板](/stage3-framework/ch13)、[第 14 章 输出解析器](/stage3-framework/ch14)，把本章中的 "模型接入" 和后续的 "输入组织""输出解析" 串成完整闭环。
