...
- [Prompt 模板](/stage3-framework/ch13)、[聊天模型](/stage3-framework/ch11)、[输出解析器](/stage3-framework/ch14)
- 后面会学到的检索器、工具、甚至整条链
...
如果把 [第 13 章](/stage3-framework/ch13)、[第 11 章](/stage3-framework/ch11)、[第 14 章](/stage3-framework/ch14) 放在一起看，你会发现最典型的一条链就是：
...
- **链的核心主线** 是前面几章内容的自然延伸：把 [提示词模板](/stage3-framework/ch13)、[模型调用](/stage3-framework/ch11)、[输出解析器](/stage3-framework/ch14) 组织成一条可执行流程。
...
**建议下一步：** 先把本章 5 个案例都跑一遍，重点观察“每一步输入输出是什么、为什么能接上下一步”；然后继续学习 [第 16 章 记忆与对话历史](/stage3-framework/ch16) 和 [第 17 章 Tools 工具调用](/stage3-framework/ch17)，你会更清楚链式调用如何进一步扩展成带状态、带工具、带决策能力的 LLM 应用。
