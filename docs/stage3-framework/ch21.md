...
这一点和 [第 16 章 记忆与对话历史（含Redis基础）](/stage3-framework/ch16) 是连着的。第 16 章更偏“记忆是什么、怎么存历史消息”，而这里更偏“在 `create_agent` 这条 1.x 主线上，状态和短期记忆是怎么接进 Agent 运行时的”。
...
也正因为如此，本章和 [第 20 章 MCP 模型上下文协议](/stage3-framework/ch20) 是强关联的：第 20 章解决“工具怎么标准化暴露”，第 21 章解决“Agent 怎么把这些能力真正用起来”。
