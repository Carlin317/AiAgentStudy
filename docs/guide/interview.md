...
**对应章节：**[1-3 RAG、微调、续训与智能体选型 §1、RAG](/stage1-foundation/ch01-3#1、rag)；[1-3 RAG、微调、续训与智能体选型 §2、微调（Fine-tuning）](/stage1-foundation/ch01-3#2、微调%EF%BC%88fine-tuning%EF%BC%89)
...
**对应章节：**[21 Agent智能体 §1、Agent 简介](/stage3-framework/ch21#1、agent-简介)；[1-3 RAG、微调、续训与智能体选型 §4、智能体开发](/stage1-foundation/ch01-3#4、智能体开发)
...
**对应章节：**[1-3 RAG、微调、续训与智能体选型 §1、RAG](/stage1-foundation/ch01-3#1、rag)；[1-3 RAG、微调、续训与智能体选型 §4、智能体开发](/stage1-foundation/ch01-3#4、智能体开发)
...
**对应章节：**[1-1 大模型认知与工程概览 §1、认识大模型](/stage1-foundation/ch01-1#1、认识大模型)；[11 Model I/O 与模型接入 §2、LangChain 模型分类、参数与返回](/stage3-framework/ch11#2、langchain-模型分类、参数与返回)
...
**对应章节：**[1-1 大模型认知与工程概览 §4、大模型的工程实现（概览）](/stage1-foundation/ch01-1#4、大模型的工程实现%EF%BC%88概览%EF%BC%89)；[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)
...
**对应章节：**[13 提示词与消息模板 §3、入参的消息类型](/stage3-framework/ch13#3、入参的消息类型)；[13 提示词与消息模板 §7、对话提示词模板（ChatPromptTemplate）](/stage3-framework/ch13#7、对话提示词模板%EF%BC%88chatprompttemplate%EF%BC%89)
...
**对应章节：**[14 输出解析器 §1、输出解析器简介](/stage3-framework/ch14#1、输出解析器简介)；[14 输出解析器 §4、结构化输出](/stage3-framework/ch14#4、结构化输出)
...
**对应章节：**[13 提示词与消息模板 §1、Prompt 简介](/stage3-framework/ch13#1、prompt-简介)；[17 Tools工具调用 §6、从课程案例走向真实项目](/stage3-framework/ch17#6、从课程案例走向真实项目)
...
**对应章节：**[1-2 提示词工程基础 §2、提示词怎么写](/stage1-foundation/ch01-2#2、提示词怎么写)；[14 输出解析器 §8、实际开发选择](/stage3-framework/ch14#8、实际开发选择)
...
**对应章节：**[1-2 提示词工程基础 §4、提示词工程的边界](/stage1-foundation/ch01-2#4、提示词工程的边界)；[13 提示词与消息模板 §1、Prompt 简介](/stage3-framework/ch13#1、prompt-简介)
...
**对应章节：**[13 提示词与消息模板 §8、从文件加载提示词](/stage3-framework/ch13#8、从文件加载提示词)；[1-2 提示词工程基础 §5、提示词工程的几个注意点](/stage1-foundation/ch01-2#5、提示词工程的几个注意点)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](/stage3-framework/ch19#1、rag-简介)；[19 RAG检索增强生成 §2、RAG 文本处理核心知识](/stage3-framework/ch19#2、rag-文本处理核心知识)
...
**对应章节：**[19 RAG检索增强生成 §2、RAG 文本处理核心知识](/stage3-framework/ch19#2、rag-文本处理核心知识)；[2-RAG 搭建企业私有&个人知识库 §2、知识库的概述](/stage1-foundation/ch02#2、知识库的概述)
...
**对应章节：**[19 RAG检索增强生成 §2、RAG 文本处理核心知识](/stage3-framework/ch19#2、rag-文本处理核心知识)；[19 RAG检索增强生成 §3、RAG 综合案例：智能运维助手](/stage3-framework/ch19#3、rag-综合案例：智能运维助手)
...
**对应章节：**[18 向量数据库与Embedding实战 §6、向量库的写入与检索](/stage3-framework/ch18#6、向量库的写入与检索%EF%BC%88rag-的底层能力%EF%BC%89)；[19 RAG检索增强生成 §2、RAG 文本处理核心知识](/stage3-framework/ch19#2、rag-文本处理核心知识)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](/stage3-framework/ch19#1、rag-简介)；[21 Agent智能体 §6、小结：Agent、Tool、Function Calling、RAG、MCP 的区别与联系](/stage3-framework/ch21#6、小结：agent、tool、function-calling、rag、mcp-的区别与联系)
...
**对应章节：**[2-RAG 搭建企业私有&个人知识库 §2、知识库的概述](/stage1-foundation/ch02#2、知识库的概述)；[19 RAG检索增强生成 §3、RAG 综合案例：智能运维助手](/stage3-framework/ch19#3、rag-综合案例：智能运维助手)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](/stage3-framework/ch19#1、rag-简介)；[1-1 大模型认知与工程概览 §1、认识大模型](/stage1-foundation/ch01-1#1、认识大模型)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](/stage3-framework/ch19#1、rag-简介)；[21 Agent智能体 §1、Agent 简介](/stage3-framework/ch21#1、agent-简介)
...
**对应章节：**[18 向量数据库与Embedding实战 §2、向量数据库](/stage3-framework/ch18#2、向量数据库)；[18 向量数据库与Embedding实战 §6、向量库的写入与检索](/stage3-framework/ch18#6、向量库的写入与检索%EF%BC%88rag-的底层能力%EF%BC%89)
...
**对应章节：**[18 向量数据库与Embedding实战 §1、向量与向量化](/stage3-framework/ch18#1、向量与向量化)；[18 向量数据库与Embedding实战 §4、Embedding 文本向量化](/stage3-framework/ch18#4、embedding-文本向量化)
...
**对应章节：**[18 向量数据库与Embedding实战 §4、Embedding 文本向量化](/stage3-framework/ch18#4、embedding-文本向量化)；[18 向量数据库与Embedding实战 §6、向量库的写入与检索](/stage3-framework/ch18#6、向量库的写入与检索%EF%BC%88rag-的底层能力%EF%BC%89)
...
**对应章节：**[18 向量数据库与Embedding实战 §2、向量数据库](/stage3-framework/ch18#2、向量数据库)；[18 向量数据库与Embedding实战 §5、通过向量计算语义相似度](/stage3-framework/ch18#5、通过向量计算语义相似度)
...
**对应章节：**[21 Agent智能体 §3、Agent 工作原理（V0.3）](/stage3-framework/ch21#3、agent-工作原理%EF%BC%88v0.3%EF%BC%89)；[17 Tools工具调用 §2、工具调用的工作方式](/stage3-framework/ch17#2、工具调用的工作方式)
...
**对应章节：**[17 Tools工具调用 §1、Tools 简介](/stage3-framework/ch17#1、tools-简介)；[21 Agent智能体 §6、小结：Agent、Tool、Function Calling、RAG、MCP 的区别与联系](/stage3-framework/ch21#6、小结：agent、tool、function-calling、rag、mcp-的区别与联系)
...
**对应章节：**[21 Agent智能体 §1、Agent 简介](/stage3-framework/ch21#1、agent-简介)；[21 Agent智能体 §6、小结：Agent、Tool、Function Calling、RAG、MCP 的区别与联系](/stage3-framework/ch21#6、小结：agent、tool、function-calling、rag、mcp-的区别与联系)
...
**对应章节：**[17 Tools工具调用 §1、Tools 简介](/stage3-framework/ch17#1、tools-简介)；[17 Tools工具调用 §2、工具调用的工作方式](/stage3-framework/ch17#2、工具调用的工作方式)
...
**对应章节：**[17 Tools工具调用 §3、自定义 Tool](/stage3-framework/ch17#3、自定义-tool：从最简单的工具开始)；[17 Tools工具调用 §4、参数 schema：为什么要配合 Pydantic](/stage3-framework/ch17#4、参数-schema：为什么要配合-pydantic)
...
**对应章节：**[17 Tools工具调用 §5、天气助手实战](/stage3-framework/ch17#5、天气助手实战：把-tool-跑成业务闭环)；[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)
...
**对应章节：**[17 Tools工具调用 §6、从课程案例走向真实项目](/stage3-framework/ch17#6、从课程案例走向真实项目)；[17 Tools工具调用 §4、参数 schema：为什么要配合 Pydantic](/stage3-framework/ch17#4、参数-schema：为什么要配合-pydantic)
...
**对应章节：**[14 输出解析器 §4、结构化输出](/stage3-framework/ch14#4、结构化输出)；[17 Tools工具调用 §2、工具调用的工作方式](/stage3-framework/ch17#2、工具调用的工作方式)
...
**对应章节：**[17 Tools工具调用 §6、从课程案例走向真实项目](/stage3-framework/ch17#6、从课程案例走向真实项目)；[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)
...
**对应章节：**[22 LangGraph概述与快速入门 §1、LangGraph 简介](/stage3-framework/ch22#1、langgraph-简介)；[23 LangGraphAPI：图与状态 §1、Graph API 之 Graph](/stage3-framework/ch23#1、graph-api-之-graph%EF%BC%88图%EF%BC%89)
...
**对应章节：**[23 LangGraphAPI：图与状态 §2、Graph API 之 State](/stage3-framework/ch23#2、graph-api-之-state%EF%BC%88状态%EF%BC%89)；[24 LangGraphAPI：节点、边与进阶 §2、Graph API 之 Edge](/stage3-framework/ch24#2、graph-api-之-edge%EF%BC%88边%EF%BC%89)
...
**对应章节：**[9 LangChain概述与架构 §2、LangChain 定位](/stage3-framework/ch09#2、langchain-定位)；[9 LangChain概述与架构 §4、LangChain 核心模块](/stage3-framework/ch09#4、langchain-核心模块)
...
**对应章节：**[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)；[17 Tools工具调用 §5、天气助手实战](/stage3-framework/ch17#5、天气助手实战：把-tool-跑成业务闭环)
...
**对应章节：**[15 LCEL与链式调用 §1、Runnable 与统一调用方式](/stage3-framework/ch15#1、runnable-与统一调用方式)；[15 LCEL与链式调用 §2、LCEL 简介](/stage3-framework/ch15#2、lcel-简介)
...
**对应章节：**[25 LangGraph高级特性 §1、流式处理（Streaming）](/stage3-framework/ch25#1、流式处理%EF%BC%88streaming%EF%BC%89)；[25 LangGraph高级特性 §2、状态持久化（Persistence）](/stage3-framework/ch25#2、状态持久化%EF%BC%88persistence%EF%BC%89)；[25 LangGraph高级特性 §3、时间回溯（Time-Travel）](/stage3-framework/ch25#3、时间回溯%EF%BC%88time-travel%EF%BC%89)；[25 LangGraph高级特性 §4、子图（Subgraphs）](/stage3-framework/ch25#4、子图%EF%BC%88subgraphs%EF%BC%89)
...
**对应章节：**[25 LangGraph高级特性 §2、状态持久化（Persistence）](/stage3-framework/ch25#2、状态持久化%EF%BC%88persistence%EF%BC%89)；[25 LangGraph高级特性 §3、时间回溯（Time-Travel）](/stage3-framework/ch25#3、时间回溯%EF%BC%88time-travel%EF%BC%89)
...
**对应章节：**[16 记忆与对话历史 §1、记忆简介](/stage3-framework/ch16#1、记忆简介)；[25 LangGraph高级特性 §2、状态持久化（Persistence）](/stage3-framework/ch25#2、状态持久化%EF%BC%88persistence%EF%BC%89)
...
**对应章节：**[16 记忆与对话历史 §4、RunnableWithMessageHistory 与 BaseChatMessageHistory](/stage3-framework/ch16#4、实现类介绍：runnablewithmessagehistory-与-basechatmessagehistory)；[25 LangGraph高级特性 §2、状态持久化（Persistence）](/stage3-framework/ch25#2、状态持久化%EF%BC%88persistence%EF%BC%89)
...
**对应章节：**[20 MCP模型上下文协议 §2、MCP 简介](/stage3-framework/ch20#2、mcp-简介)；[20 MCP模型上下文协议 §3、MCP 能做什么](/stage3-framework/ch20#3、mcp-能做什么)
...
**对应章节：**[20 MCP模型上下文协议 §2、MCP 简介](/stage3-framework/ch20#2、mcp-简介)；[17 Tools工具调用 §2、工具调用的工作方式](/stage3-framework/ch17#2、工具调用的工作方式)
...
**对应章节：**[20 MCP模型上下文协议 §5、MCP 架构知识](/stage3-framework/ch20#5、mcp-架构知识)
...
**对应章节：**[20 MCP模型上下文协议 §5、MCP 架构知识](/stage3-framework/ch20#5、mcp-架构知识)；[20 MCP模型上下文协议 §3、MCP 能做什么](/stage3-framework/ch20#3、mcp-能做什么)
...
**对应章节：**[20 MCP模型上下文协议 §4、怎么用 MCP](/stage3-framework/ch20#4、怎么用-mcp)；[20 MCP模型上下文协议 §6、案例实战：本地 MCP 天气服务与客户端](/stage3-framework/ch20#6、案例实战：本地-mcp-天气服务与客户端)
...
**对应章节：**[26 LangGraph多智能体与A2A §1、A2A 协议与多智能体架构](/stage3-framework/ch26#1、a2a-协议与多智能体架构)；[26 LangGraph多智能体与A2A §2、Supervisor 与 Handoff](/stage3-framework/ch26#2、supervisor-与-handoff)；[26 LangGraph多智能体与A2A §3、Skills 与多智能体的边界](/stage3-framework/ch26#3、skills-与多智能体的边界)；[27 Agent Skills智能体技能与AI编程工具实践](/stage3-framework/ch27)
...
**对应章节：**[3 基于Coze&Dify平台的智能体开发 §1、智能体(AI Agent)概述](/stage2-lowcode/ch03#1、智能体ai-agent概述)；[9 LangChain概述与架构 §2、LangChain 定位](/stage3-framework/ch09#2、langchain-定位)
...
**对应章节：**[9 LangChain概述与架构 §2、LangChain 定位](/stage3-framework/ch09#2、langchain-定位)；[22 LangGraph概述与快速入门 §1、LangGraph 简介](/stage3-framework/ch22#1、langgraph-简介)
...
**对应章节：**[3 基于Coze&Dify平台的智能体开发 §6、工作流的搭建](/stage2-lowcode/ch03#6、工作流的搭建)；[21 Agent智能体 §1、Agent 简介](/stage3-framework/ch21#1、agent-简介)
...
**对应章节：**[4 Python调用Dify平台工作流 §4、请求格式](/stage2-lowcode/ch04#4、请求格式)；[5 Python调用Coze平台工作流 §3、通过 Python 代码调用工作流](/stage2-lowcode/ch05#3-通过-python-代码调用工作流)
...
**对应章节：**[19 RAG检索增强生成 §3、RAG 综合案例：智能运维助手](/stage3-framework/ch19#3、rag-综合案例：智能运维助手)；[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](/stage3-framework/ch19#1、rag-简介)；[14 输出解析器 §4、结构化输出](/stage3-framework/ch14#4、结构化输出)
...
**对应章节：**[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)；[17 Tools工具调用 §6、从课程案例走向真实项目](/stage3-framework/ch17#6、从课程案例走向真实项目)
...
**对应章节：**[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)；[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)
...
**对应章节：**[19 RAG检索增强生成 §2、RAG 文本处理核心知识](/stage3-framework/ch19#2、rag-文本处理核心知识)；[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)
...
**对应章节：**[17 Tools工具调用 §6、从课程案例走向真实项目](/stage3-framework/ch17#6、从课程案例走向真实项目)；[19 RAG检索增强生成 §3、RAG 综合案例：智能运维助手](/stage3-framework/ch19#3、rag-综合案例：智能运维助手)
...
**对应章节：**[11 Model I/O 与模型接入 §2、LangChain 模型分类、参数与返回](/stage3-framework/ch11#2、langchain-模型分类、参数与返回)；[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)
...
**对应章节：**[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)；[7 企业级大模型部署 §3、模型部署](/stage2-lowcode/ch07#3、模型部署)；[12 Ollama本地部署与调用 §5、LangChain 整合 Ollama](/stage3-framework/ch12#5、langchain-整合-ollama)
...
**对应章节：**[2-RAG 搭建企业私有&个人知识库 §5、使用 Dify 搭建知识库](/stage1-foundation/ch02#5、使用-dify-搭建知识库)；[19 RAG检索增强生成 §3、RAG 综合案例：智能运维助手](/stage3-framework/ch19#3、rag-综合案例：智能运维助手)
...
**对应章节：**[3 基于Coze&Dify平台的智能体开发 §7、项目：商户运营管家](/stage2-lowcode/ch03#7、项目：商户运营管家)；[21 Agent智能体 §5、实操与案例](/stage3-framework/ch21#5、实操与案例)
...
**对应章节：**[24 LangGraphAPI：节点、边与进阶 §2、Graph API 之 Edge](/stage3-framework/ch24#2、graph-api-之-edge%EF%BC%88边%EF%BC%89)；[21 Agent智能体 §4、Agent 工作原理（V1.0）](/stage3-framework/ch21#4、agent-工作原理%EF%BC%88v1.0%EF%BC%89)
...
**对应章节：**[9 LangChain概述与架构 §2、LangChain 定位](/stage3-framework/ch09#2、langchain-定位)；[7 企业级大模型部署 §1、企业级大模型部署概述](/stage2-lowcode/ch07#1、企业级大模型部署概述)
