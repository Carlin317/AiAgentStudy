...
**建议下一步：** 如果你想继续走 Coze 本地化和私有化路线，可以看 [第 6 章 Coze 与 Dify 的 Windows 平台部署](/stage2-lowcode/ch06)；如果你想从平台调用进一步过渡到代码框架主线，也可以回到 [第 9 章 LangChain 概述与架构](/stage3-framework/ch09) 开始进入 LangChain 学习。
