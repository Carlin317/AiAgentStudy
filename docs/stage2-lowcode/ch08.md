---
title: "8 - Docker 入门与 Dify 部署常见问题"
---
<div v-pre>
...
| 现在遇到的问题                    | 建议先看                                                       |
| --------------------------------- | -------------------------------------------------------------- |
| 还没安装 Docker Desktop           | [第 6 章 2.1 安装 Docker Desktop](/stage2-lowcode/ch06#21-安装-docker-desktop环境准备) |
| 分不清镜像、容器、Compose、数据卷 | 第 1 部分：Docker 基础与命令速查                               |
| 第一次安装 Dify                   | [第 6 章 4、Dify 的安装和启动](/stage2-lowcode/ch06#4、dify-的安装和启动) |
...
| 查看容器挂载     | `docker inspect <容器名> --format '<span v-pre>{{json .Mounts}}</span>'`                            |
